...
class TxnMallTest(FTMTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 FTM:
        ...
        # First: use raw transaction API to send 1240 FTM to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 FTM coin each
        ...
        # Node0's balance should be starting balance, plus 50FTM for another
        ...
        # Node0's total balance should be starting balance, plus 100FTM for 
