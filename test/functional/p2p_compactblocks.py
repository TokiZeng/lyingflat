...
# TestNode: A peer we use to send messages to ftmd, and store responses.
...
class CompactBlocksTest(FTMTestFramework):
    ...
    # This test actually causes ftmd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that ftmd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for ftmd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(node, test_node, version):
        # ftmd will not send blocktxn responses for blocks whose height is
