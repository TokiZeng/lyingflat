...
class TestFTMCli(FTMTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `ftm-cli getinfo`")
        ...
        self.log.info("Compare responses from `ftm-cli -getinfo` and the RPCs data is retrieved from.")
