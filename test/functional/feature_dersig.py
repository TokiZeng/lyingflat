...
class BIP66Test(FTMTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # ftmd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and ftmd produces more specific reject
            # reasons.
