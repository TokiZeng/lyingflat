...
class AssetTest(FTMTestFramework):
    ...
    def big_test(self):
        ...
        n0.listassets(asset="FTM*", verbose=False, count=2, start=-2)
        ...
        ftm_assets = n0.listassets(asset="FTM*", verbose=False, count=2, start=-2)
        assert_equal(len(ftm_assets), 2)
        assert_equal(ftm_assets[0], "FTM2")
        assert_equal(ftm_assets[1], "FTM3")
        self.sync_all()
