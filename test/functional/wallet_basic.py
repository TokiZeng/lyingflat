...
class WalletTest(FTMTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 FTM from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 FTM with subtract fee from amount
        ...
        # Sendmany 10 FTM with subtract fee from amount
