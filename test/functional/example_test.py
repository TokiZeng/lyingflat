...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the FTMTestFramework
    pass

class ExampleTest(FTMTestFramework):
    # Each functional test is a subclass of the FTMTestFramework class.
    ...
    def custom_method(self):
        ...
        FTMTestFramework class so other tests can use it."""
