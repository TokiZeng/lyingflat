...
By default, ftmd will dump mempool on shutdown and
...
class MempoolPersistTest(FTMTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give ftmd a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent ftmd from writing mempool.dat to disk. Verify that `savemempool` fails")
