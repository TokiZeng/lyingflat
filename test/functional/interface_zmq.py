...
import os
import struct
from test_framework.test_framework import FTMTestFramework, SkipTest
...
# noinspection PyUnresolvedReferences
class ZMQTest(FTMTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that ftm has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("ftmd has not been built with zmq enabled.")
