...
This document provides guidelines for internationalization of the FTM Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `ftm_en.ts` remains unchanged.
