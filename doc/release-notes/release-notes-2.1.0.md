FTM Core version *2.1.0* is now available!!
==============

  <https://github.com/FTMProject/FTMcoin/releases/tag/v2.1.0>
...
Changelog available here: <https://github.com/FTMProject/FTMcoin/commits/release_2.1.0>
