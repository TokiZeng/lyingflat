...
find ${DISTNAME}/bin -type f -executable -exec ../ftmcoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../ftmcoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/ftmcoin/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/ftmcoin/depends/SDKs/MacOSX10.11.sdk.tar.gz
