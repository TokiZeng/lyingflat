...
#include "config/ftm-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatFTMURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + FTMUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatFTMURI(info));
}
