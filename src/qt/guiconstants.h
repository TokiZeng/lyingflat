...
#ifndef FTM_QT_GUICONSTANTS_H
#define FTM_QT_GUICONSTANTS_H
...
/* FTMGUI -- Size of icons in status bar */
...
/* FTMcoin shadow color - light mode */
...
/* FTMcoin label color as a string */
...
#define QAPP_ORG_NAME "FTM"
#define QAPP_ORG_DOMAIN "ftm.org"
#define QAPP_APP_NAME_DEFAULT "FTM-Qt"
#define QAPP_APP_NAME_TESTNET "FTM-Qt-testnet"

/* Default third party browser urls */
#define DEFAULT_THIRD_PARTY_BROWSERS "https://api.ftmcoin.org/tx/%s|https://ftm.cryptoscope.io/tx/?txid=%s|https://blockbook.ftmcoin.org/tx/%s|https://explorer.mangofarmassets.com/tx/%s|https://www.assetsexplorer.com/tx/%s|https://explorer.ftmland.org/tx/%s"

/* Default IPFS viewer */
#define DEFAULT_IPFS_VIEWER "https://ipfs.io/ipfs/%s"

#endif // FTM_QT_GUICONSTANTS_H
