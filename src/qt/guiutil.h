...
#ifndef FTM_QT_GUIUTIL_H
#define FTM_QT_GUIUTIL_H
...
/** Utility functions used by the FTM Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "ftm:" URI into recipient object, return true on successful parsing
