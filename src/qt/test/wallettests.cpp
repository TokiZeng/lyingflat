...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<FTMAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_ftm-qt -platform xcb      # Linux
//     src/qt/test/test_ftm-qt -platform windows  # Windows
//     src/qt/test/test_ftm-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = FTMUnits::formatWithUnit(unit, balance, false, FTMUnits::separatorAlways);
    ...
    // Amount input
    FTMAmountField* amountInput = receiveCoinsDialog.findChild<FTMAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: ftm:")) != -1);
