...
#ifndef FTM_QT_FTMGUI_H
#define FTM_QT_FTMGUI_H
...
/**
  FTM GUI main class. This class represents the main window of the FTM UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class FTMGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit FTMGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~FTMGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a ftm wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
