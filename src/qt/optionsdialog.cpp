    ...
    mapper(0)
{
    ...
    ui->ftmAtStartup->setToolTip(ui->ftmAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->ftmAtStartup->setText(ui->ftmAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openFTMConfButton->setToolTip(ui->openFTMConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new FTMUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->ftmAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openFTMConfButton_clicked()
{
