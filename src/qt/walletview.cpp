...
void WalletView::setFTMGUI(FTMGUI *gui)
{
    if (gui)
    {
...
void WalletView::setWalletModel(WalletModel *_walletModel)
{
    ...
    if (_walletModel)
    {
        ...
        // update HD status
        Q_EMIT hdEnabledStatusChanged(_walletModel->hd44Enabled() ? FTMGUI::HD44_ENABLED : _walletModel->hdEnabled() ? FTMGUI::HD_ENABLED : FTMGUI::HD_DISABLED);
