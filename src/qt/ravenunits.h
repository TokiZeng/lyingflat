...
#ifndef FTM_QT_FTMUNITS_H
#define FTM_QT_FTMUNITS_H
...
/** FTM unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class FTMUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit FTMUnits(QObject *parent);
...
typedef FTMUnits::Unit FTMUnit;

#endif // FTM_QT_FTMUNITS_H
