...
{
    const char* pszTimestamp = "The Times 01/Oct/2024 lyingflat.info";
...
public:
    CMainParams() {
        ...
        //vSeeds.emplace_back("seed-ftm.bitactivate.com", false);
        //vSeeds.emplace_back("seed-ftm.ftmcoin.com", false);
        //vSeeds.emplace_back("seed-ftm.ftmcoin.org", false);

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,55); // 'L' 開頭的地址
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,117); // 'f' 開頭的地址
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1,131); // 你自己的私鑰前綴
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xC2, 0x2F}; // HD 公鑰
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xAD, 0xF4}; // HD 私鑰

        // FTM BIP44 cointype in mainnet is '175'
        nExtCoinType = 807;
        ...
        chainTxData = ChainTxData{
            // Update as we know more about the contents of the FTM chain
...
//        /////////////////////////////////////////////////////////////////
        ...
        //vSeeds.emplace_back("seed-testnet-ftm.bitactivate.com", false);
        //vSeeds.emplace_back("seed-testnet-ftm.ftmcoin.com", false);
        //vSeeds.emplace_back("seed-testnet-ftm.ftmcoin.org", false);
