...
#ifndef FTMCOIN_ASSET_PROTOCOL_H
#define FTMCOIN_ASSET_PROTOCOL_H
...
bool CheckIssueDataTx(const CTxOut& txOut); // OP_FTM_ASSET FTMQ (That is a Q as in Que not an O)
bool CheckOwnerDataTx(const CTxOut& txOut);// OP_FTM_ASSET FTMO
bool CheckReissueDataTx(const CTxOut& txOut);// OP_FTM_ASSET FTMR
bool CheckTransferOwnerTx(const CTxOut& txOut);// OP_FTM_ASSET FTMT
...
#endif //FTMCOIN_ASSET_PROTOCOL_H
