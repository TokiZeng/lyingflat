...
#ifndef FTM_TEST_SCRIPTNUM10_H
#define FTM_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from FTM Core 0.10.0, for cross-comparison.
 */
public:
