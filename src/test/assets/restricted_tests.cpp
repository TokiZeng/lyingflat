...
BOOST_FIXTURE_TEST_SUITE(restricted_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(verify_new_restricted_transaction_test) {
        ...
        // Create filler ftm tx
        CScript ftmTransfer = GetScriptForDestination(DecodeDestination(GetParams().GlobalBurnAddress()));
        CTxOut ftmOut(1*COIN, ftmTransfer);
        ...
        mutTxTest1.vout.emplace_back(ftmOut);
        ...
        mutTxTest2.vout.emplace_back(ftmOut);
        ...
        mutTxTest3.vout.emplace_back(ftmOut);
        ...
        mutTxTest4.vout.emplace_back(ftmOut);
        ...
        mutTxTest5.vout.emplace_back(ftmOut);
        ...
        mutTxTest6.vout.emplace_back(ftmOut);
        ...
        mutTxTest7.vout.emplace_back(ftmOut);
        ...
        mutTxTest8.vout.emplace_back(ftmOut);
